...
- ماسح Binance (سواء عبر أوامر CLI أو عند التشغيل التلقائي من داخل المحرر) يتجاهل تلقائيًا الأزواج التي تحتوي أحدث سجلات `latest_events` على طابع زمني يطابق الشمعة الحالية أو الشمعة السابقة، لضمان عرض الرموز التي لم تشهد حدثًا فوريًا عند لحظة المسح.
