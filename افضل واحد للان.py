...
_METRIC_MAP = {
    ...
    "IDM OB لمس": ["IDM_OB_TOUCHED","idm ob touched"],
    "IDM OB جديد": ["IDM_OB_NEW","idm ob new"],
    "Hist IDM OB": ["HIST_IDM_OB","hist_idm_ob","hist idm ob"],
    "Hist EXT OB": ["HIST_EXT_OB","hist_ext_ob","hist ext ob"],
    "FVG صاعدة": ["FVG_BULLISH","FVG_UP","fvg up","FVG_BULLISH_NEW","FVG_BULLISH_MITIGATED"],
    "FVG هابطة": ["FVG_BEARISH","FVG_DN","fvg down","FVG_BEARISH_NEW","FVG_BEARISH_MITIGATED"],
    "EXT OB لمس": ["EXT_OB_TOUCHED","ext ob touched"],
    "EXT OB جديد": ["EXT_OB_NEW","ext ob new"],
